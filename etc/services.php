...
return function (ContainerBuilder $containerBuilder) {
    $containerBuilder->addDefinitions([
        ...
        SlimAppTwig::class => function (ContainerInterface $c) {
            ...
            if (is_dir(__DIR__ . "/../src/baseapp/html")) {
                $directories["slimbaseapp"] = __DIR__ . "/../src/baseapp/html";
            }
            ...
            $view->addRuntimeLoader(new class implements TwigRuntimeLoaderInterface
            {
