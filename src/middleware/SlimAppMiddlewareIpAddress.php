...
class SlimAppMiddlewareIpAddress extends SlimAppMiddlewareBase
{
    /**
    ...
    public function __construct($options)
    {
        ...
        if ($this->checkProxyHeaders && $this->trustedProxies === null) {
     ...
     * @return string
     */
    protected function determineClientIpAddress(Request $request)
    {
        $ipAddress = null;
